...
subprocess.call(["kmc", "-fm", "-k"+kmerSize, "-ci1", refFile, "reference", "referenceFolderKMC"])

print "Kmercount of the read file"
subprocess.call(["kmc", "-fa", "-k"+kmerSize, "-ci1", readFile, "read", "readFolderKMC"])

print "Merging"
subprocess.call(["kmc_tools", "intersect",   "reference", "read","-ci1", "intersection"])

print "Dumping"
subprocess.call(["kmc_dump", "intersection", outFile])
